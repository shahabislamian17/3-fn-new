...
import { createProject } from '@/lib/api-frontend-services';
...
function ProjectDetailsForm({ form }: { form: any }) {
    ...
    const categorySelectOptions = categoryOptions.map(cat => ({ label: cat, value: cat }));
...
const OwnerFeeReview = ({ control }: { control: any }) => {
...
function PreLaunchChecklist({ form }: { form: any }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const projectData = {
                ...
                owner: {
                  id: user.uid,
                  name: user.displayName || 'Unnamed Owner',
                  avatarUrl: user.photoURL || 'https://images.unsplash.com/photo-1531891437562-4301cf35b7e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw3fHxtYW4lMjBwcm9maWxlfGVufDB8fHx8MTc2MjU0NDYwMXww&ixlib=rb-4.1.0&q=80&w=1080',
        ...
        <div className="mt-8">
            ...
            <Card className="mt-6">
             ...
             <div className="flex justify-end gap-2 mt-4">
                ...
                <Button onClick={handleSubmit} disabled={!termsAccepted || isLoading}>
