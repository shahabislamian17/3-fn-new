...
import { getPublicProject } from '@/lib/api-frontend-services';
...
export async function generateMetadata(
  ...
  try {
    ...
    const url = `${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/projects/${project.slug}`;
...
export default async function ProjectDetailsPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    'offers': {
        '@type': 'Offer',
        'url': `${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/projects/${project.slug}`,
