...
const createAdminSchema = z.object({
  ...
  role: z.enum(['Admin', 'ComplianceOfficer', 'Support', 'AccountingOperator']),
});
...
export default function UserManagementPage() {
  ...
  function handleCreateUser(data: CreateAdminFormValues) {
    ...
    // to invite a user, which would then trigger an email.
    toast({
      title: 'Admin User Created (Simulated)',
      description: `${data.name} has been invited as a(n) ${data.role}.`,
    });
