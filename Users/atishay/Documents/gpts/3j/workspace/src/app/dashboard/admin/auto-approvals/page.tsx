...
// In a real app, this would be in a separate api-client.ts file
async function getAutoApprovalStats() {
    const res = await fetch('/api/v1/admin/auto-approval/stats');
    if (!res.ok) throw new Error('Failed to fetch stats');
    return res.json();
}
async function getAutoApprovalHistory() {
    const res = await fetch('/api/v1/admin/auto-approval/history');
